...
/**
 * Represents a service adapted.
 * @author <a href="mailto:marcos@compor.net">Marcos Pereira</a>
 * @version 1.0
 */
public abstract class AdaptedService extends AbstractService {

  /** Adapter has this adapted service. */
  private Adapter adapter;

  /**
   * Creates a new reference to <code>AdaptedService</code>.
   * @param _specification
   *          specification of the adapted service.
   */
  public AdaptedService(final ServiceSpecification _specification) {
    super(_specification);
  }

  /**
   * Returns the adapter reference.
   * @return Adapter reference for this service adapted.
   */
  ...
  /**
   * Sets the adapter reference for this service adapted.
   * @param _adapter
   *          adapter reference for this service adapted.
   */
  ...
  /**
   * Implements the adaptation of a service. This method must be override by
   * subclasses to implement the adaptation of a service.
   * @param _serviceRequest
   *          Service request.
   * @return ServiceResponse The response of the service
   ...
   */
  public abstract ServiceResponse invokeService(ServiceRequest _serviceRequest)
