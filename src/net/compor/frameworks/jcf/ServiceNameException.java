 ...
 * @version 1.0
 */
public class ServiceNameException extends ComporRuntimeException {

  /**
   * Creates a new instance of the <code>ServiceNameException</code> class.
   */
  ...
  protected String getFormattedMessage() {
    return ComporResourceBundleMessageFormat.formatProperty(JCFMessages
        .getInstance().get("exception.servicename"), //$NON-NLS-1$
        new Object[] {});
  }
}
