...
/**
 * This exception is throw during the invocation of a service.
 * @author <a href="mailto:emerson@compor.net">Emerson Loureiro</a>
 * @version 1.0
 */
public abstract class ServiceInvocationException extends ComporException {

  /**
   * Creates a new <code>ComporServiceInvocationException</code>.
   */
  ...
  /**
   * Creates a new <code>ComporServiceInvocationException</code> with the
   * specified cause.
   * @param _cause
   *          cause of the exception.
   */
  public ServiceInvocationException(final Throwable _cause) {
    super(_cause);
  }
}
