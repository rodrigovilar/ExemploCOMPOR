...
/**
 * This exceptions is throw when event name is null.
 * @author <a href="mailto:mario@compor.net">Mario Hozano</a>
 * @version 1.0
 */
public class EventNameException extends ComporRuntimeException {

  /**
   * Creates a new instance of <code>EventNameException</code>.
   */
  ...
  protected String getFormattedMessage() {
    return ComporResourceBundleMessageFormat.formatProperty(JCFMessages
        .getInstance().get("exception.eventname"), //$NON-NLS-1$
        new Object[] {});
  }
}
